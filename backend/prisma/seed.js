...
exports.SEED_PRODUCTS = exports.SEED_RULES = void 0;
exports.main = main;
...
exports.SEED_PRODUCTS = [
    ...
    },
    {
        ...
        certifications: [
            { type: 'FSSAI', identifier: '10014064000435', status: 'Active', source: 'FSSAI' },
            { type: 'Whole Grain Council', identifier: 'WGC-100', status: 'Verified', source: 'Industry Body' }
        ]
    },
    {
        name: "Bagrry's Crunchy Muesli Almond Raisin & Honey",
        brand: "Bagrry's",
        category: 'Cereal',
        manufacturer: 'Bagrrys India Limited',
        barcodeGtIN: '8901768012019',
        packSize: '400g',
        price: 280,
        imageUrl: 'https://images.unsplash.com/photo-1517093707579-2244f075d9e9?auto=format&fit=crop&w=600&q=80',
        countryOfOrigin: 'India',
        sourceType: 'INTERNAL',
        sourceName: 'PackCheck Verified DB',
        nutrition: {
        ...
        ingredient: {
            ingredientText: 'Rolled Oats (42%), Whole Wheat Flakes (28%), Invert Syrup, Raisins (8%), Almonds (4%), Honey, Apple Juice Concentrate, Wheat Bran.',
            allergens: ['Oats', 'Wheat', 'Tree Nuts (Almonds)']
        },
        verification: {
            authority: 'FSSAI',
            identifier: '10012011000492',
            status: 'Verified',
            evidenceType: 'FOSCOS_RECORD',
            sourceUrl: 'https://foscos.fssai.gov.in',
            details: 'Bagrrys India Limited registered manufacturing license.'
        },
        certifications: [
            { type: 'FSSAI', identifier: '10012011000492', status: 'Active', source: 'FSSAI' }
        ]
    },
    // 5. MILK & DAIRY ALTERNATIVES
    {
        ...
        nutrition: {
            ...
            protein: 3.2,
            carbohydrates: 4.7,
            sugar: 4.7, // naturally occurring lactose
            addedSugar: 0.0,
            fat: 3.0,
            saturatedFat: 1.9,
            transFat: 0.0,
        ...
        certifications: [
            ...
            { type: '+F Fortified', identifier: 'FORT-AMUL-01', status: 'Verified', source: 'FSSAI FFRC' }
        ]
    },
    {
        ...
        certifications: [
            ...
            { type: 'Vegan', identifier: 'VEG-IN-981', status: 'Verified', source: 'Vegan Society' }
        ]
    },
    // 6. JUICE & BEVERAGES
    {
        ...
        ingredient: {
            ingredientText: 'Water, Mixed Fruit Concentrate (Apple, Banana, Mango, Orange, Guava, Apricot, Peach, Pineapple), Sugar, Acidity Regulator (Citric Acid), Antioxidant (Ascorbic Acid).',
            allergens: []
        },
        verification: {
            authority: 'FSSAI',
    ...
    },
    {
        ...
        nutrition: {
            ...
            carbohydrates: 10.5,
            sugar: 8.5,
            addedSugar: 0.0, // 100% juice, no added sugar
            fat: 0.1,
            saturatedFat: 0.0,
            transFat: 0.0,
            fiber: 0.6,
    ...
    // 7. INSTANT NOODLES
    {
        ...
        nutrition: {
            ...
            transFat: 0.1,
            fiber: 3.6,
            sodium: 1020, // Very high sodium
            iron: 3.7
        },
        ingredient: {
            ingredientText: 'Noodles: Refined wheat flour (Maida), Palm oil, Salt, Wheat gluten, Mineral (Calcium carbonate), Thickeners. Tastemaker: Hydrolysed groundnut protein, Mixed spices (23.6%) (Dehydrated onion, Coriander powder, Red chilli, Turmeric, Cumin), Noodle powder, Sugar, Edible starch, Palm oil, Caramel salt.',
            allergens: ['Wheat', 'Groundnut / Peanut', 'May contain Mustard, Milk, Soy']
        },
        verification: {
            authority: 'FSSAI',
    ...
    },
    {
        ...
        ingredient: {
            ingredientText: 'Wheat Flour (Maida), Refined Palm Oil, Iodised Salt, Wheat Gluten, Spices & Condiments, Dehydrated Vegetables (Carrot, Cabbage), Hydrolysed Vegetable Protein, Flavour Enhancers.',
            allergens: ['Wheat', 'Soy']
        },
        verification: {
            authority: 'FSSAI',
            ...
            evidenceType: 'FOSCOS_RECORD',
            sourceUrl: 'https://foscos.fssai.gov.in',
            details: 'ITC Limited packaged foods registration verified.'
        },
        certifications: [
            { type: 'FSSAI', identifier: '10012031000312', status: 'Active', source: 'FSSAI' }
        ]
    },
    {
        ...
        nutrition: {
            ...
            transFat: 0.0,
            fiber: 6.8,
            sodium: 210 // significantly lower sodium
        },
        ingredient: {
            ingredientText: 'Millet Flour (Foxtail Millet, Little Millet - 50%), Whole Wheat Flour (Atta), Cluster Bean Powder, Salt. Tastemaker: Natural spice blend with cumin, turmeric, coriander, black pepper.',
            allergens: ['Wheat']
        },
        verification: {
            authority: 'FSSAI',
        ...
        certifications: [
            ...
            { type: 'Jaivik Bharat', identifier: 'JB-ORG-2023-11', status: 'Verified', source: 'Organic Board' }
        ]
    },
    // 8. PROTEIN PRODUCTS
    {
        ...
        manufacturer: 'Tirupati Lifesciences Pvt. Ltd. (under Glanbia licence)',
        ...
        ingredient: {
            ingredientText: 'Protein Blend (Whey Protein Isolate, Whey Protein Concentrate, Whey Peptides), Cocoa Powder, Natural & Artificial Flavours, Lecithin, Acesulfame Potassium, Aminogen, Lactase.',
            allergens: ['Milk', 'Soy']
        },
        verification: {
            authority: 'FSSAI',
        ...
        certifications: [
            ...
            { type: 'Informed Choice', identifier: 'IC-ON-WHEY-2024', status: 'Verified', source: 'LGC Group' }
        ]
    },
    {
        ...
        ingredient: {
            ingredientText: 'Whey Protein Concentrate, Almonds, Hazelnuts, Prebiotic Fiber (Oligofructose), Cocoa Butter, Honey, Natural Tocopherol.',
    ...
    {
        name: 'RiteBite Max Protein Daily Choco Classic Bar',
        brand: 'RiteBite',
        category: 'Protein Products',
        manufacturer: 'Naturell (India) Pvt. Ltd.',
        barcodeGtIN: '8906009531021',
        packSize: '50g',
        price: 75,
        imageUrl: 'https://images.unsplash.com/photo-1622484216834-8c88747a8efb?auto=format&fit=crop&w=600&q=80',
        countryOfOrigin: 'India',
        ...
        ingredient: {
            ingredientText: 'Protein Blend (Soy Protein Isolate, Whey Protein Concentrate, Calcium Caseinate), Dark Compound, Maltitol, Dietary Fiber, Glycerine, Cocoa Powder.',
            allergens: ['Soy', 'Milk']
        },
        verification: {
            authority: 'FSSAI',
            identifier: '10013021000861',
            status: 'Verified',
            evidenceType: 'FOSCOS_RECORD',
            sourceUrl: 'https://foscos.fssai.gov.in',
            details: 'Naturell India manufacturing unit active on FoSCoS.'
        },
        certifications: [
            { type: 'FSSAI', identifier: '10013021000861', status: 'Active', source: 'FSSAI' }
        ]
    },
    // 9. SNACKS & NAMKEEN
    {
        ...
        nutrition: {
            ...
            addedSugar: 0.0,
            fat: 42.0,
            saturatedFat: 18.0, // High saturated fat
            transFat: 0.1,
            fiber: 4.2,
            sodium: 890 // High sodium
        },
        ingredient: {
            ingredientText: 'Potatoes (44%), Edible Vegetable Oil (Palmolein), Bengal Gram Flour (Tepary Beans Flour), Iodised Salt, Red Chilli Powder, Black Pepper, Clove Powder, Cardamom Powder, Ginger Powder.',
            allergens: []
        },
        verification: {
            authority: 'FSSAI',
        ...
        certifications: [
            ...
            { type: 'Agmark', identifier: 'AGMARK-HAL-492', status: 'Verified', source: 'Directorate of Marketing & Inspection' }
        ]
    },
    {
    ...
    },
    {
        ...
        certifications: [
            ...
            { type: 'Jaivik Bharat', identifier: 'JB-SEED-412', status: 'Verified', source: 'Organic Certification' }
        ]
    },
    // 10. PRODUCT WITH NEEDS REVIEW / MISSING VERIFICATION STATUS (For realistic demo of compliance states)
    {
        name: 'Artisan Bakery Crunchy Almond Biscotti',
        brand: 'Artisan Oven',
        category: 'Biscuits',
        manufacturer: 'Local Bakehouse Works',
        barcodeGtIN: '8909999000018',
        packSize: '150g',
        price: 180,
        ...
        ingredient: {
            ingredientText: 'Flour, Sugar, Almonds, Butter, Eggs, Vanilla, Baking Powder.',
            allergens: ['Wheat', 'Egg', 'Tree Nuts (Almond)']
        },
        verification: {
            authority: 'FSSAI',
            identifier: '20019000000123',
            status: 'Needs Review',
            evidenceType: 'PUBLIC_LABEL_MATCH',
            sourceUrl: 'https://foscos.fssai.gov.in',
            details: 'State license renewal pending audit. Verification evidence flagged for review.'
        },
        certifications: []
    },
    {
        name: 'StreetStyle Tangy Chat Masala Sev',
        brand: 'Desi Crunch',
        category: 'Snacks',
        manufacturer: 'Desi Snacks LLP',
        barcodeGtIN: '8908888000021',
        packSize: '100g',
        price: 25,
        imageUrl: 'https://images.unsplash.com/photo-1599488615731-7e5c2823ff28?auto=format&fit=crop&w=600&q=80',
        countryOfOrigin: 'India',
        ...
        nutrition: {
            ...
            fat: 38.0,
            saturatedFat: 16.5,
            transFat: 0.3, // trans-fat alert!
            fiber: 2.0,
            sodium: 920 // high sodium
        },
        ingredient: {
            ingredientText: 'Gram flour, partially hydrogenated vegetable oil, iodised salt, mixed spices, permitted food colour.',
            allergens: []
        },
        verification: {
            authority: 'FSSAI',
            identifier: 'NOT_FOUND_ON_PACK',
            status: 'Verification Unavailable',
            evidenceType: 'BARCODE_GTIN_RECORD',
            sourceUrl: '',
            details: '14-digit FSSAI license number is missing or unverified on retail packaging.'
        },
        certifications: []
    }
];
async function main() {
    ...
    for (const rule of exports.SEED_RULES) {
    ...
    console.log(`Seeding ${exports.SEED_PRODUCTS.length} PackCheck products...`);
    for (const p of exports.SEED_PRODUCTS) {
